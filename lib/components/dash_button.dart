...
class FeaturesHelper extends StatefulWidget {
  ...
  @override
  State<FeaturesHelper> createState() => _FeaturesHelperState();
}

class _FeaturesHelperState extends State<FeaturesHelper> {
  @override
